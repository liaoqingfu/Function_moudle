...
#define ERROR_FILE_MD5_CHECK_FAIL                   (-101) // add by yuxw.
...
#define CAM_MAIN_ROOTFS_SYS  "cam_3518_rootfs_sys"
...
#define FLOODLIGHT_SYSTEM    "floodlight_sys"


#define VERSION_PATH         "/tmp"
//#define VERSION_TF_PATH      "/media/mmcblk0p1"
#define VERSION_TF_PATH      "/mnt/sdcard"

#define HUB_MAIN_VER_NAME    "7628_emmc.img"

#define FLOODLIGHT_VER_NAME   "update-OTA.bin"
...
#define DEV_ROOTFS_VER_NAME  "3518e_rootfs.bin"
...
//#define	SD_DEV_EXIST_FILE		"/sys/block/mmcblk0/mmcblk0p1/size"
#define	SD_DEV_EXIST_FILE		"/mnt/sdcard"
...
/*
从文件中读取MD5值
参数 file_path: md5文件存放的路径，需要完整的路径和名字
参数 md5_buf : 传出参数
success返回0，false返回-1
*/
...
/*
将MD5值写入文件中
参数 file_path: md5文件写入的路径，会自动在后面加上 .md5后缀
参数 md5_buf : MD5值，传入参数
success返回0，false返回-1
*/
...
int check_upgrade_file_with_md5( char * file_path );				// add by yuxw
