...
timer_handle_t set_a_timer(int interval, int (* timer_proc) (void *arg, int arg_len), unsigned int time_sec,void *arg, int arg_len)
{
    int i;
	...
	timer_manage.value.it_interval.tv_sec = time_sec;
